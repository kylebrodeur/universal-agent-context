# Gemini Code Context for UACS Project
...
Gemini has a large context window, but for optimal performance:
- Use the MCP server to provide relevant context on-demand
- Leverage the UACS memory system to track important project information
- Use the CLI tools to query project state efficiently

### Integration with UACS
The UACS system can be used as a context provider for Gemini through:
1. **MCP Protocol** - Direct integration via Model Context Protocol
2. **CLI Tools** - Query context and inject into prompts
3. **Memory System** - Persistent storage of conversation history and insights
